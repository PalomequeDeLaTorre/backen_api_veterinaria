...
mongoose
  ...
  .connect('mongodb+srv://carlospdti22:T0anMN2QvanAcYh5@cluster0.lojtckl.mongodb.net/mascotas?retryWrites=true&w=majority&appName=Cluster0')
  .then((x) => {
...
const mascotaRutas = require('./routes/mascota.routes'); 
app.use('/api', mascotaRutas);
